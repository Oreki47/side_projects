...
engine = sqlalchemy.create_engine('mysql+mysqlconnector://<mysql_user_name>:<mysql_password>@127.0.0.1/<database_name>?charset=utf8mb4') # replace <> parts in the string
